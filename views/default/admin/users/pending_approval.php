<?php
	...
	if($body = elgg_list_entities($options, "elgg_get_entities_from_relationship", "uservalidationbyadmin_view_users_list")){
		...
		$check_all = elgg_view("input/checkbox", array("name" => "check_all", "id" => "uservalidationbyadmin-check-all", "value" => 1));
		
		$bulk_actions = "<span class='float-alt'>";
		$bulk_actions .= elgg_view("output/confirmlink", array("text" => elgg_echo("uservalidationbyadmin:validate"), "href" => "action/uservalidationbyadmin/bulk_action?do=validate", "id" => "uservalidationbyadmin-bulk-validate"));
		$bulk_actions .= " | ";
		$bulk_actions .= elgg_view("output/confirmlink", array("text" => elgg_echo("delete"), "href" => "action/uservalidationbyadmin/bulk_action?do=delete", "id" => "uservalidationbyadmin-bulk-delete"));
		$bulk_actions .= "</span>";
